...
{
    public class ExpertiseCategoryConfiguration : IEntityTypeConfiguration<ExpertiseCategory>
    {
        public void Configure(EntityTypeBuilder<ExpertiseCategory> builder)
        {
            builder.ToTable("ExpertiseCategory");
