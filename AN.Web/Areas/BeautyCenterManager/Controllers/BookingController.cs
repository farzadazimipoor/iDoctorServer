...
{
    public class BookingController : BeautyCenterManagerController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = new BeautyCenterBookingViewModel { Date = DateTime.Now };
        ...
        public async Task<IActionResult> FinalBookConfirm(int serviceSupplyId, int centerServiceId, int patientId, DateTime start, DateTime end)
        {
            ...
            var model = new BeautyCenterConfirmBookingViewModel
            {
                BookingData = new BeautyCenterBookingViewModel
                {
