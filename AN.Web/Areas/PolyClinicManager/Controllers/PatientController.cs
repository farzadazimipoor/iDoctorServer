    ...
    public class PatientController : PolyclinicManagerController
    {
        ...
        public async Task<IActionResult> LoadTable([FromBody]DataTablesParameters param)
        {
            try
            {
                ...
                var results = await _patientService.GetDataTableAsync(CurrentPolyclinic.Id, param, filtersModel, Lng);
        ...
        public async Task<IActionResult> FindPerson(FindPersonModel model)
        {
            ...
            else
            {
                ...
                {
                    DoctorsList = (await _serviceSupplyService.GetSelectListAsync(CurrentPolyclinic.Id, CurrentPolyclinic.ServiceSupplyIds)).ToList(),
        ...
        public async Task<IActionResult> Attachments(int id)
        {
            ...
            EnsureAllowAccess(patient.ServiceSupplyId ?? 0);
