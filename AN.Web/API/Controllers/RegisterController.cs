...
namespace AN.Web.API.Controllers
{
    ...
    [ApiController]
    public class RegisterController : ANBaseApiController
    {
        ...
        public async Task<IActionResult> RegisterCenters(RegisterPoliClinicViewModel model)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(model.Mobile)) throw new AwroNoreException("Mobile is not valid");
            ...
            catch (Exception e)
            {
                ...
                if (e is AwroNoreException) throw e;
